...
def drive(cfg, model_path=None, use_joystick=False, model_type=None,
    ...
    if camera_type == "stereo":
        ...
        if cfg.DONKEY_GYM:
            ...
            cam = DonkeyGymEnv(cfg.DONKEY_SIM_PATH, host=cfg.SIM_HOST, env_name=cfg.DONKEY_GYM_ENV_NAME,
                               conf=cfg.GYM_CONF, record_location=cfg.SIM_RECORD_LOCATION,
                               record_gyroaccel=cfg.SIM_RECORD_GYROACCEL, record_velocity=cfg.SIM_RECORD_VELOCITY,
                               record_lidar=cfg.SIM_RECORD_LIDAR, delay=cfg.SIM_ARTIFICIAL_LATENCY)
            threaded = True
        ...
        if cfg.DONKEY_GYM:
            ...
            if cfg.SIM_RECORD_GYROACCEL:
                outputs += ['gyro/gyro_x', 'gyro/gyro_y', 'gyro/gyro_z', 'accel/accel_x', 'accel/accel_y',
                            'accel/accel_z']
    ...
    if cfg.INFO_OVERLAY:
        ...
        V.add(InfoOverlayLogger(),
              inputs=['fps/current', 'user/mode', 'user/throttle', 'user/angle', 'pilot/throttle', 'pilot/angle'],
              outputs=['info/info_list'])
    ...
    if hasattr(cfg, "WEB_CHECK_CAR_INERT"):
        ctr = LocalWebController(port=cfg.WEB_CONTROL_PORT, mode=cfg.WEB_INIT_MODE, check_inert=cfg.WEB_CHECK_CAR_INERT,
                                 js_config={'JOYSTICK_MAX_THROTTLE': cfg.JOYSTICK_MAX_THROTTLE,
    ...
    if cfg.STOP_SIGN_DETECTOR:
        ...
        V.add(
            StopSignDetector(cfg.STOP_SIGN_MIN_SCORE, cfg.STOP_SIGN_SHOW_BOUNDING_BOX, cfg.STOP_SIGN_MAX_REVERSE_COUNT),
    ...
    if cfg.DONKEY_GYM or cfg.DRIVE_TRAIN_TYPE == "MOCK":
        ...
        left_motor = L298N_HBridge_DC_Motor(cfg.HBRIDGE_L298N_PIN_LEFT_FWD, cfg.HBRIDGE_L298N_PIN_LEFT_BWD,
                                            cfg.HBRIDGE_L298N_PIN_LEFT_EN)
        right_motor = L298N_HBridge_DC_Motor(cfg.HBRIDGE_L298N_PIN_RIGHT_FWD, cfg.HBRIDGE_L298N_PIN_RIGHT_BWD,
